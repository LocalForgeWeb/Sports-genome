...
export default function Home() {
  ...
  return <div className="apex-shell">
    ...
    <aside className={`apex-rail ${railOpen ? "rail-open" : ""}`}>
      ...
      <div className="rail-bottom"><div className="rail-data-card"><p className="metric-label">Research engine</p><div className="mt-2 flex items-end justify-between"><p className="font-display text-4xl font-bold text-white">{sportProfiles.length}</p><span className="mb-1 text-[10px] font-bold text-[#b8ff5b]">SPORTS</span></div><p className="mt-1 text-[11px] leading-4 text-[#8d9c95]">{sportMovementProfiles.length} movement profiles linked to {exercises.length} exercises.</p></div><a href="https://localforgeweb.com" target="_blank" rel="noreferrer" className="mt-4 block text-[10px] text-[#77857f]">Built by Gabe Naim — LocalForgeWeb</a></div>
    </aside>
