    ...
    <div className="apex-main">
      <header className="apex-topbar">
        <div className="flex min-w-0 items-center gap-3">
          <img src="/manus-storage/sports-genome-circular-header-badge_8450998e.jpg" alt="Sports Genome circular badge" className="topbar-brand-logo shrink-0 object-cover" />
