...
type Workspace = "command" | "profile" | "recommended" | "custom" | "day-plan" | "body" | "movement" | "catalog" | "genome" | "strength";
...
export default function Home() {
  ...
  return <div className="apex-shell">
    ...
    <aside className={`apex-rail ${railOpen ? "rail-open" : ""}`}>
      <div className="rail-brand"><img src="/manus-storage/sports-genome-official-logo-64_f1d0979d.png" alt="Sports Genome icon" className="h-11 w-11 shrink-0 object-contain" /><p className="font-display text-[26px] font-bold uppercase tracking-wide text-white">Sports Genome</p><button onClick={() => setRailOpen(false)} className="ml-auto text-[#c8d8e7] lg:hidden" aria-label="Close navigation"><X className="h-5 w-5" /></button></div>
    ...
    <div className="apex-main">
      ...
      <Suspense fallback={<main className="apex-content"><div className="light-panel p-6 text-sm text-[#58728e]">Loading Exercise Genome analysis…</div></main>}><main className={`apex-content ${workspace === "catalog" ? "catalog-mode-active" : ""}`}>
        ...
        {workspace === "strength" && <StrengthGenomePanel />}
      </main></Suspense>
