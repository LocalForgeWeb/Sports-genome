  ...
  return <div className="apex-shell">
    ...
    <div className="mobile-workspace-dock lg:hidden" aria-label="Current workspace actions">
      <div className="mobile-workspace-actions">
        ...
        {workspace !== "day-plan" && workspace !== "command" && workspace !== "strength" && workspace !== "progress" && workspace !== "profile" && <><span><strong>{navItems.find((item) => item.id === workspace)?.label}</strong><small>Use the focused tools for this workspace</small></span><button type="button" onClick={() => navigateWorkspace("movement")}>Movement Atlas</button><button type="button" onClick={() => navigateWorkspace("day-plan")}>Training day</button></>}
      </div>
