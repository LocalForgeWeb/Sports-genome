...
function Onboarding({ onComplete }: { onComplete: (profile: { goal: Goal; trainingDays: number; sportId: string; stackMode: StackMode }) => void }) {
  ...
  return <div className="pulse-shell"><div className="pulse-orb pulse-orb-one" /><div className="pulse-orb pulse-orb-two" /><header className="pulse-header"><div className="flex items-center gap-2"><img src="/manus-storage/sports-genome-circular-header-badge_8450998e.jpg" alt="Sports Genome circular badge" className="pulse-brand-badge" /><span className="font-display text-2xl font-bold uppercase tracking-wide text-white">Sports Genome</span></div><div className="pulse-progress"><span>STEP {step + 1} / 4</span><div>{[0, 1, 2, 3].map((index) => <i key={index} className={index <= step ? "pulse-progress-on" : ""} />)}</div></div></header><main className="pulse-main">
    ...
    <div className="apex-main">
      <header className="apex-topbar">
        <div className="flex min-w-0 items-center gap-3">
          <img src="/manus-storage/sports-genome-circular-header-badge_8450998e.jpg" alt="Sports Genome circular badge" className="topbar-brand-logo shrink-0 object-contain" />
