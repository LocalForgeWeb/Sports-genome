...
const navItems: { id: Workspace; label: string; icon: typeof Target; detail: string }[] = [
  ...
  { id: "genome", label: "Exercise Genome", icon: Dna, detail: "contextual exercise intelligence" },
];
...
export default function Home() {
  ...
  return <div className="apex-shell">
    ...
    <div className="apex-main">
      ...
      {workspace === "custom" && <div className="split-draft-dock"><SplitDraftControls days={splitDays} activeDay={splitDays.includes(activeSplitDay) ? activeSplitDay : splitDays[0]} activeLoadout={activeLoadout} onDay={setActiveSplitDay} onLoadout={setActiveLoadout} onDraft={loadDraft} /></div>}
    </div>
