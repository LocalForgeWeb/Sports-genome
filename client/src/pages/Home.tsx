    ...
    <div className="apex-main">
      <header className="apex-topbar">
        <div className="flex min-w-0 items-center gap-3">
          <img src="/manus-storage/sports-genome-upright-s-dna-logo_5c4f7a92.jpg" alt="Sports Genome upright S/DNA logo" className="topbar-brand-logo shrink-0 object-contain" />
