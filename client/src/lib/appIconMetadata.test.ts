...
describe("Sports Genome app icon metadata", () => {
  it("uses the supplied upright S/DNA artwork for the favicon and Apple touch icon", () => {
    expect(html).toContain('rel="apple-touch-icon" sizes="180x180" href="https://qiccnqkypbhlwpmjcsri.supabase.co/storage/v1/object/public/sports-genome-assets/sports-genome-upright-s-dna-180_c496e9d0.png"');
    expect(html).toContain('rel="icon" type="image/png" sizes="64x64" href="https://qiccnqkypbhlwpmjcsri.supabase.co/storage/v1/object/public/sports-genome-assets/sports-genome-upright-s-dna-64_904d4b7b.png"');
