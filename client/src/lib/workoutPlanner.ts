...
const programmingTargets: Record<TrainingGoal, ProgrammingTarget> = {
  ...
  "Muscle growth": { goal: "Muscle growth", sessionSetBand: [12, 24], workingSetCue: "Use enough technically sound work to accumulate recoverable volume; exercise- and athlete-specific set needs differ.", repetitionCue: "Growth can occur across a broad loading spectrum when effort and technique are appropriate; 6–15 repetitions is one practical option, not a required zone.", restCue: "Rest for at least about 60 seconds and extend it when doing so preserves useful repetitions, load, and technique.", weeklyVolumeCue: "Approximately 10 weekly hard sets per muscle can be a starting reference; adjust for performance, fatigue, recovery, and the contribution of compound lifts.", evidenceBoundary: "Weekly-set and repetition figures are evidence-informed planning references, not a measured personal optimum or a guaranteed result." },
  "Max strength": { goal: "Max strength", sessionSetBand: [9, 18], workingSetCue: "Keep primary work heavy and quality-focused; 2–3 sets per primary exercise is a general starting anchor, not a fixed athlete requirement.", repetitionCue: "Primary work often emphasizes lower-repetition loading, with a 1–6 repetition emphasis used in many advanced strength programs; assistance work can extend the practice dose.", restCue: "About 3–5 minutes can help preserve repeated high-force efforts; exercise complexity, load, and readiness can require a different interval.", weeklyVolumeCue: "Protect high-quality practice and recoverable exposure rather than adding sets solely to increase a count.", evidenceBoundary: "The app does not know 1RM, readiness, technical proficiency, or sport calendar; strength ranges require individual adjustment." },
