...
import { Check, Dumbbell, Fingerprint, PencilLine, Scale, ShieldCheck, SunMoon, Trash2, UserRound } from "lucide-react";
import { useTheme } from "@/contexts/ThemeContext";
import { themeOptionCopy, themePreferences, type ThemePreference } from "@/lib/theme";
import { startRegistration } from "@simplewebauthn/browser";
import { toast } from "sonner";
import { trpc } from "@/lib/trpc";
import type { AthleteBaseline, AthleteExperience, SexForReference, WeightUnit } from "@/components/AthleteBaselineQuiz";
 ...
 */
const contextModes: { value: SportContextMode; label: string; detail: string }[] = [
  { value: "sport", label: "I train for a sport", detail: "Loads the movement demands that sport asks for." },
  { value: "general", label: "General strength and resilience", detail: "No sport. Strength, capacity and body-region goals all stay available." },
  { value: "undecided", label: "Decide later", detail: "Skip it for now. You can pick a sport whenever you want." },
];

export function AthleteAboutMePanel({ baseline, goal, trainingDays, sportId, sportContextMode = "sport", sports, onBaseline, onGoal, onDays, onSport, onSportContextMode = () => {}, capacityFocus = { reportedSignals: [] }, targetCatalog, onCapacityFocus = () => {}, identity, syncPending = 0, benchmarkOptIn = false, onBenchmarkOptIn = () => {} }: {
