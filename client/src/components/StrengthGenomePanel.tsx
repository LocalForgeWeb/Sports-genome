...
function StrengthRegionRecordDetail({ region, observations, onClose }: { region: StrengthRegionDefinition; observations: StrengthObservationRecord[]; onClose: () => void }) {
...
export function StrengthGenomePanel({ onOpenTraining = () => {} }: { onOpenTraining?: () => void }) {
  ...
  return <section className="space-y-5">
    <div className="view-header">
      ...
      {selectedRegion && <StrengthRegionRecordDetail region={selectedRegion} observations={(observations.data || []) as StrengthObservationRecord[]} onClose={() => setSelectedRegion(null)} />}
