...
- The quiz headline uses coral only for the decisive training bias; electric blue stays reserved for progress, ambient depth, and workflow feedback.
- Every outcome card carries a compact force/tissue/repeatability/transfer inspection cue so the choice reads as a programming trade-off rather than a general preference.
